...
import java.net.*;   // to use the socket
import java.io.*;

public class Client implements ActionListener { // action listener comes from awt event package
    
    JTextField text;    // globally declare 
    static JPanel a1;         //globally declare
    ...
    Client (){             // Constructor
        ...
        f.setLocation(800,50); // so the frame doesnt open in the corner
